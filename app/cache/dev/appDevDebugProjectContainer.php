...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'security.user.provider.concrete.en_memoria' => 'getSecurity_User_Provider_Concrete_EnMemoriaService',
            'security.user.provider.concrete.proveedor_encadenado' => 'getSecurity_User_Provider_Concrete_ProveedorEncadenadoService',
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'C:/xampp/htdocs/molina/sirecoog/app/cache/dev/annotations', true);
    }
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, 'C:/xampp/htdocs/molina/sirecoog/app/Resources');
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b->setNamespace('sf2orm_default_cfe3e422651fb4843bbadbcedd10c2e196cf4a4141cf01917010ebc33100cf14');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_cfe3e422651fb4843bbadbcedd10c2e196cf4a4141cf01917010ebc33100cf14');

        $d = new \Doctrine\Common\Cache\ArrayCache();
        $d->setNamespace('sf2orm_default_cfe3e422651fb4843bbadbcedd10c2e196cf4a4141cf01917010ebc33100cf14');

        $e = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => 'C:\\xampp\\htdocs\\molina\\sirecoog\\src\\Sirecoog\\UsuarioBundle\\Entity', 1 => 'C:\\xampp\\htdocs\\molina\\sirecoog\\src\\Sirecoog\\RecaudoBundle\\Entity', 2 => 'C:\\xampp\\htdocs\\molina\\sirecoog\\src\\Sirecoog\\AgenciaBundle\\Entity'));

        $f = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $f->addDriver($e, 'Sirecoog\\UsuarioBundle\\Entity');
        $f->addDriver($e, 'Sirecoog\\RecaudoBundle\\Entity');
        $f->addDriver($e, 'Sirecoog\\AgenciaBundle\\Entity');

        $g = new \Doctrine\ORM\Configuration();
        $g->setEntityNamespaces(array('SirecoogUsuarioBundle' => 'Sirecoog\\UsuarioBundle\\Entity', 'SirecoogRecaudoBundle' => 'Sirecoog\\RecaudoBundle\\Entity', 'SirecoogAgenciaBundle' => 'Sirecoog\\AgenciaBundle\\Entity'));
        $g->setMetadataCacheImpl($b);
        $g->setQueryCacheImpl($c);
        $g->setResultCacheImpl($d);
        $g->setMetadataDriverImpl($f);
        $g->setProxyDir('C:/xampp/htdocs/molina/sirecoog/app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), 'C:/xampp/htdocs/molina/sirecoog/app/Resources');
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('C:/xampp/htdocs/molina/sirecoog/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:C:/xampp/htdocs/molina/sirecoog/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, 'C:/xampp/htdocs/molina/sirecoog/app/cache/dev/assetic/routing.yml', array('cache_dir' => 'C:/xampp/htdocs/molina/sirecoog/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true, 'resource_type' => 'yaml'), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('Sirecoog\\UsuarioBundle\\Entity\\Usuario' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\PlaintextPasswordEncoder', 'arguments' => array(0 => false)), 'Symfony\\Component\\Security\\Core\\User\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\PlaintextPasswordEncoder', 'arguments' => array(0 => false))));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_AreaSeguraService()
    {
        ...
        $c = $this->get('security.user.provider.concrete.proveedor_encadenado');
        ...
        $h = new \Symfony\Component\HttpFoundation\RequestMatcher('^/sirecoog/about');

        $i = new \Symfony\Component\HttpFoundation\RequestMatcher('^/sirecoog/login');

        $j = new \Symfony\Component\HttpFoundation\RequestMatcher('^/sirecoog/*');
        ...
        $m = new \Symfony\Component\Security\Http\RememberMe\TokenBasedRememberMeServices(array(0 => $c), 'POPOTokenIsNotSoSecretChangeIt', 'area_segura', array('lifetime' => 3600, 'path' => '/', 'name' => 'REMEMBERME', 'domain' => NULL, 'secure' => false, 'httponly' => true, 'always_remember_me' => false, 'remember_me_parameter' => '_remember_me'), $a);

        $n = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $l, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($l, 'usuario_login'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => 'usuario_logout'));
        $n->addHandler(new \Symfony\Component\Security\Http\Logout\SessionLogoutHandler());
        $n->addHandler($m);

        $o = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationSuccessHandler($l, array('login_path' => 'usuario_login', 'default_target_path' => 'hello2', 'always_use_default_target_path' => true, 'target_path_parameter' => '_target_path', 'use_referer' => false));
        $o->setProviderKey('area_segura');

        $p = new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $g, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $l, 'area_segura', $o, new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($f, $l, array('login_path' => 'usuario_login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'), $a), array('check_path' => 'usuario_login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $a, $d, $this->get('form.csrf_provider'));
        $p->setRememberMeServices($m);

        return $this->services['security.firewall.map.context.area_segura'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($k, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $c, 1 => $this->get('security.user.provider.concrete.en_memoria'), 2 => $this->get('security.user.provider.concrete.usuarios_bd')), 'area_segura', $a, $d), 2 => $n, 3 => $p, 4 => new \Symfony\Component\Security\Http\Firewall\RememberMeListener($b, $m, $g, $a, $d), 5 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '54dd2a371fae2', $a), 6 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $k, $g)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $l, 'area_segura', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($f, $l, 'usuario_login', false), NULL, NULL, $a));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('C:/xampp/htdocs/molina/sirecoog/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        $this->services['sensio_distribution.webconfigurator'] = $instance = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('C:/xampp/htdocs/molina/sirecoog/app');
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('C:/xampp/htdocs/molina/sirecoog/app/cache/dev/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, 'C:/xampp/htdocs/molina/sirecoog/app', 'UTF-8');
    }
    ...
    protected function getTemplating_Helper_LogoutUrlService()
    {
        ...
        $instance->registerListener('area_segura', 'usuario_logout', 'logout', '_csrf_token', NULL);
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, 'C:/xampp/htdocs/molina/sirecoog/app', 'UTF-8'));
        ...
        $instance->addGlobal('login_iniciado', 'jmolina');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('C:\\xampp\\htdocs\\molina\\sirecoog\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('C:\\xampp\\htdocs\\molina\\sirecoog\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\SecurityBundle/Resources/views', 'Security');
        $instance->addPath('C:\\xampp\\htdocs\\molina\\sirecoog\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\TwigBundle/Resources/views', 'Twig');
        $instance->addPath('C:\\xampp\\htdocs\\molina\\sirecoog\\vendor\\symfony\\swiftmailer-bundle\\Symfony\\Bundle\\SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('C:\\xampp\\htdocs\\molina\\sirecoog\\vendor\\doctrine\\doctrine-bundle\\Doctrine\\Bundle\\DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('C:\\xampp\\htdocs\\molina\\sirecoog\\src\\Sirecoog\\UsuarioBundle/Resources/views', 'SirecoogUsuario');
        $instance->addPath('C:\\xampp\\htdocs\\molina\\sirecoog\\src\\Sirecoog\\RecaudoBundle/Resources/views', 'SirecoogRecaudo');
        $instance->addPath('C:\\xampp\\htdocs\\molina\\sirecoog\\src\\Sirecoog\\AgenciaBundle/Resources/views', 'SirecoogAgencia');
        $instance->addPath('C:\\xampp\\htdocs\\molina\\sirecoog\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('C:\\xampp\\htdocs\\molina\\sirecoog\\vendor\\sensio\\distribution-bundle\\Sensio\\Bundle\\DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('C:/xampp/htdocs/molina/sirecoog/app/Resources/views');
        $instance->addPath('C:\\xampp\\htdocs\\molina\\sirecoog\\vendor\\symfony\\symfony\\src\\Symfony\\Bridge\\Twig/Resources/views/Form');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('POPOTokenIsNotSoSecretChangeIt');
    }
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addXmlMappings(array(0 => 'C:\\xampp\\htdocs\\molina\\sirecoog\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml'));
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'C:/xampp/htdocs/molina/sirecoog/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('C:/xampp/htdocs/molina/sirecoog/app/cache/dev/assetic/assets');
    }
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        ...
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($this->get('security.user.provider.concrete.proveedor_encadenado'), $a, 'area_segura', $this->get('security.encoder_factory'), true), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\RememberMeAuthenticationProvider($a, 'POPOTokenIsNotSoSecretChangeIt', 'area_segura'), 2 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('54dd2a371fae2')), true);
    ...
    protected function getSecurity_User_Provider_Concrete_EnMemoriaService()
    {
        ...
        $instance->createUser(new \Symfony\Component\Security\Core\User\User('ryan', '1234', array(0 => 'ROLE_USER')));
    ...
    /**
     * Gets the 'security.user.provider.concrete.proveedor_encadenado' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getSecurity_User_Provider_Concrete_ProveedorEncadenadoService()
    {
        return $this->services['security.user.provider.concrete.proveedor_encadenado'] = new \Symfony\Component\Security\Core\User\ChainUserProvider(array(0 => $this->get('security.user.provider.concrete.en_memoria'), 1 => $this->get('security.user.provider.concrete.usuarios_bd')));
    }
    ...
    {
        return $this->services['security.user.provider.concrete.usuarios_bd'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'SirecoogUsuarioBundle:Usuario', 'login', NULL);
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'C:/xampp/htdocs/molina/sirecoog/app/cache/dev');
    }
    ...
    {
        return array(
            'kernel.root_dir' => 'C:/xampp/htdocs/molina/sirecoog/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'C:/xampp/htdocs/molina/sirecoog/app/cache/dev',
            'kernel.logs_dir' => 'C:/xampp/htdocs/molina/sirecoog/app/logs',
            'kernel.bundles' => array(
                ...
                'SirecoogUsuarioBundle' => 'Sirecoog\\UsuarioBundle\\SirecoogUsuarioBundle',
                'SirecoogRecaudoBundle' => 'Sirecoog\\RecaudoBundle\\SirecoogRecaudoBundle',
                'SirecoogAgenciaBundle' => 'Sirecoog\\AgenciaBundle\\SirecoogAgenciaBundle',
            ...
            'locale' => 'en',
            'secret' => 'POPOTokenIsNotSoSecretChangeIt',
            'debug_toolbar' => true,
            'debug_redirects' => false,
            'use_assetic_controller' => true,
            'sirecoog.login_iniciado' => 'jmolina',
            'sirecoog.regla_acceso_idioma' => 'en|es',
            'sirecoog.regla_acceso_texto' => '^[a-zA-Z]*$',
            ...
            'debug.container.dump' => 'C:/xampp/htdocs/molina/sirecoog/app/cache/dev/appDevDebugProjectContainer.xml',
            'debug.controller_resolver.class' => 'Symfony\\Component\\HttpKernel\\Controller\\TraceableControllerResolver',
            'debug.debug_handlers_listener.class' => 'Symfony\\Component\\HttpKernel\\EventListener\\DebugHandlersListener',
            'kernel.secret' => 'POPOTokenIsNotSoSecretChangeIt',
            ...
            'session.save_path' => 'C:/xampp/htdocs/molina/sirecoog/app/cache/dev/sessions',
            ...
            'profiler.storage.dsn' => 'file:C:/xampp/htdocs/molina/sirecoog/app/cache/dev/profiler',
            ...
            'router.resource' => 'C:/xampp/htdocs/molina/sirecoog/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'C:/xampp/htdocs/molina/sirecoog/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => 'C:/xampp/htdocs/molina/sirecoog/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => 'C:/xampp/htdocs/molina/sirecoog/app/cache/dev/assetic',
            ...
            'assetic.read_from' => 'C:/xampp/htdocs/molina/sirecoog/app/../web',
            'assetic.write_to' => 'C:/xampp/htdocs/molina/sirecoog/app/../web',
            ...
            'doctrine.orm.proxy_dir' => 'C:/xampp/htdocs/molina/sirecoog/app/cache/dev/doctrine/orm/Proxies',
